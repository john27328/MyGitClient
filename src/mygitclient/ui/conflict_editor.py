...
class ConflictEditor(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        compare_splitter.addWidget(self._labeled_edit("Current", self.current_edit))
        compare_splitter.addWidget(self._labeled_edit("Incoming", self.incoming_edit))
    ...
    @staticmethod
    def _labeled_edit(label: str, edit: QPlainTextEdit) -> QWidget:
        container = QWidget()
